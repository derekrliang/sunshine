...
import com.example.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                // Using Julian days, GMT
                getContext().getContentResolver().delete(WeatherContract.WeatherEntry.CONTENT_URI,
                        WeatherContract.WeatherEntry.COLUMN_DATE + " <= ?",
                        new String[] {Long.toString(dayTime.setJulianDay(julianStartDay-1))});

                // Using Calendar objects to manipulate dates.
                /*
                ...
                String yesterdayDate = Utility.formatDate(cal.getTime().getTime());
                getContext().getContentResolver().delete(WeatherContract.WeatherEntry.CONTENT_URI,
                        WeatherContract.WeatherEntry.COLUMN_DATE + " <= ?",
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String FORECAST_BASE_URL = "http://google.com/?"; // http://api.openweathermap.org/data/2.5/forecast/daily?";
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    notificationManager.notify(WEATHER_NOTIFICATION_ID, notifBuilder.build());
